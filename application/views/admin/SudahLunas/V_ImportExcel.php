    ...
    <main>
        ...
        <div class="menuatas">
            <div class="row align-items-center justify-content-between">
                <div class="col-xl-6">
                    <img src="<?php echo base_url(); ?>vendor/bootstrap-icons/icons/list.svg" alt="Bootstrap" ...> <b class="textmenuatas">Upload Pelanggan Pembayaran</b>
                </div>
            ...
            <div class="card mb-3 mt-3">
                ...
                <div class="card-body">
                    <div class="container">
                        ...
                        <form method="POST" enctype="multipart/form-data" action="<?php echo base_url('admin/SudahLunas/C_ImportExcel/ImportExcel') ?>">
